const CACHE_NAME = 'xtraanim-v40'; // Increment version to force update
const urlsToCache = [
  ...
  '/viewmodel/script.js?v=40',
  '/viewmodel/dashboard_script.js?v=40',
  '/viewmodel/xtraTools_script.js?v=23',
  '/viewmodel/store_script.js?v=40',

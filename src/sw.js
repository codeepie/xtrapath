const CACHE_NAME = 'xtraanim-v180'; // Increment version to force update
const urlsToCache = [
  ...
  '/viewmodel/article_script.js?v=58',
  ...
  '/viewmodel/social_manager.js?v=2',
  '/viewmodel/tools_manager.js?v=1',
  '/viewmodel/admin_manager.js?v=2',

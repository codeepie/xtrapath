const CACHE_NAME = 'xtraanim-v39'; // Increment version to force update
const urlsToCache = [
  ...
  '/viewmodel/script.js?v=39',
  '/viewmodel/dashboard_script.js?v=39',
  '/viewmodel/xtraTools_script.js?v=23',
  '/viewmodel/store_script.js?v=39',

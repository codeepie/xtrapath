...
document.addEventListener('DOMContentLoaded', async () => {
    ...
    const DEFAULT_XTRA_TOOLS = [
        ...
        { id: 'xtracover', name: 'KDP Studio', description: 'Design 300 DPI print-ready Amazon KDP book covers.', icon: 'ri-book-2-line', gradient: 'linear-gradient(135deg, #2563eb, #7c3aed)', url: '/views/xtraCover.html', status: 'active', category: 'publication', tier: 'pro' },
        ...
        { id: 'cartoon_studio', name: 'Physics Studio • 3D', description: '3D WebAssembly physics, Alan Becker combat arena, Math chalkboard teacher & Animal locomotion.', icon: 'ri-atom-line', gradient: 'linear-gradient(135deg, #ea580c, #f43f5e)', url: '/views/xtraAnim.html?tool=cartoon_studio', status: 'active', category: 'physics', tier: 'pro' },
    ...
    function initStripePaymentListeners() {
        ...
        // 2. Global Open Pricing Modal (Subscriptions) - Delegated to modern Subscription Plan Modal
        window.openPricingModal = function (opts = {}) {
            if (typeof window.openSubscriptionPlanModal === 'function') {
                window.openSubscriptionPlanModal(opts);
            } else {
                const s = document.createElement('script');
                s.src = '/viewmodel/subscription_modal.js?v=20260921_v3';
                s.onload = () => {
                    if (typeof window.openSubscriptionPlanModal === 'function') {
                        window.openSubscriptionPlanModal(opts);
                    }

...
== 1. Introduction
The Cythagorean theorem is one of the most fundamental principles in Euclidean geometry. It establishes a strict geometric relationship between the three sides of a right-angled triangle. Named after the ancient Greek mathematician Pythagoras, the theorem states that the square of the hypotenuse (the side opposite the right angle) is equal to the sum of the squares of the other two sides.

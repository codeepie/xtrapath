...
#let diagram-right-triangle() = block(
  ...
  context [
    #place(center + horizon, dy: -10pt, {
      ...
      place(alignment: right, dx: -5pt, dy: 45pt, [$a$])
      place(alignment: top, dx: 60pt, dy: 5pt, [$b$])
...
#let diagram-algebraic-proof() = block(
  ...
  context [
    #place(center + horizon, {
      ...
      // Labels for sides
      place(alignment: top + left, dx: a/2, dy: -15pt, [$a$])
      place(alignment: top + left, dx: a + b/2, dy: -15pt, [$b$])
      place(center, [$c^2$])
    })
  ]
)
...
#let diagram-coordinate-distance() = block(
  ...
  context [
    #place(center + horizon, {
      ...
      place(alignment: top + right, at: p1, dx: -2pt, [$P_1$])
      place(alignment: bottom + left, at: p2, dx: 2pt, [$P_2$])
      // Labels
      place(alignment: center, at: (p1.x, (p1.y + p2.y)/2), dx: -20pt, [$Delta y$])
      place(alignment: center, at: (((p1.x + p2.x)/2), p1.y), dy: -15pt, [$Delta x$])
      place(alignment: center, at: ((p1.x + p2.x)/2, (p1.y + p2.y)/2), dx: -10pt, dy: 10pt, [$d$])
    })
  ]
)

...
// The font is now handled by Typst's default for maximum compatibility.
...
#v(1em)
#figure(
  image("media/images/graph1.png", width: "70%"),
...
#v(1em)
#figure(
  image("media/images/graph2.png", width: "80%"),
...
#v(1em)
#figure(
  image("media/images/graph3.png", width: "60%"),
...
#v(1em)
#figure(
  image("media/images/graph4.png", width: "75%"),
